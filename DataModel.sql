...
CREATE TABLE `Weather_Forecast` (
  `Id` varchar(40) COLLATE utf8_unicode_ci  NNOT NULL,
  `PlaceId` int(10)  NULL,
  `Weather_TypeId` int(10)  NULL,
  `Wind_DirId` int(10)  NULL,
...
CREATE TABLE `Weather_Type` (
  `Id` int(10) NOT NULL,
  `Main` varchar(100) COLLATE utf8_unicode_ci  NULL,
  `Description` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE `Wind_Direction` (
  `Id` int(10) NOT NULL,
  `Direction` varchar(5) COLLATE utf8_unicode_ci  NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
